...
const TeamDetail = () => {
  ...
  // Las etiquetas salen de TICKET_STATUS; estos colores se quedan locales porque
  // in_progress/pending difieren de TICKET_STATUS.badgeClass (unificarlos es un
  // cambio visual, no parte de esta limpieza).
  const statusColors = {
  ...
  return (
    ...
    >
      ...
      <Modal
        ...
        title={memberStatsModal.member?.name || "Estadísticas"}
      >
        {/* Header */}
