                ...
                >
                  ...
                  {!disabled && (
                    <button
                      ...
                      className='ml-0.5 hover:bg-white/50 dark:hover:bg-white/10 rounded-full p-0.5'
                    >
                      <X className='w-3 h-3' />
                    </button>
                  )}
        ...
        <button
          ...
          className={`flex items-center gap-2 px-3 py-2 text-sm border border-gray-300 dark:border-night-600 rounded-lg transition-colors ${
            disabled
              ...
              : "hover:bg-gray-50 dark:hover:bg-night-800 hover:border-gray-400 dark:hover:border-night-500"
          }`}
        >
          {loading ? (
