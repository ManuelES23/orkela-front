 ...
 * Sin datos todavía (active == null) muestra solo el título.
 */
  ...
  return (
    <div className='flex flex-wrap items-center gap-x-4 gap-y-2 mb-5'>
      <div className='flex-1 min-w-0'>
        ...
        <p className='min-h-6 font-bold text-gray-900 dark:text-night-50' aria-live='polite'>
          {loaded && `${active} de ${total} formas de entrar activas`}
        </p>
      </div>
      {loaded && (
