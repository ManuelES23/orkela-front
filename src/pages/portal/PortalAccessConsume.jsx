...
const PortalAccessConsume = () => {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-[#f7f5fb] p-6'>
      ...
      >
        <div className='mx-auto mb-5 grid place-items-center w-14 h-14 rounded-2xl bg-brand-50 text-brand-600'>
          <ShieldCheck className='w-7 h-7' aria-hidden='true' />
        </div>
        <h1 className='text-xl font-extrabold text-gray-900 mb-2'>Portal de soporte</h1>
